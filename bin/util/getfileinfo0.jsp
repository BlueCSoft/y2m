...
%>
  <tr height="23" bgcolor="#FFFFFF">
    ...
    <td style="font-size:13px;padding::0px 8px 0px 8px"><a href="#" onclick="OpenLink(<%=fid%>);">
	<%=query.getString("OFILENAME")%></a><span style="color:#666666">(<%=query.getString("FILESIZEC")%>×Ö½Ú)</span></td>
  </tr>
<%   rcount++;
    }
    if(rcount>0){%>
