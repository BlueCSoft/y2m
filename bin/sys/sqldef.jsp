      ...
      <tr>
        <td width="460"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <option value="D">字典</option>  	
            <option value="C">收银</option>
            <option value="A">辅助</option>  
            <option value="R">报表(POS)</option>  
            <option value="O">报表(PC)</option>  	 	
            <option value="S">系统</option> 
            <option value="I">接口</option>  		
...
<tr><td>
    ...
    <script>
       ...
       DBGrid.items.addEx({fieldName:"SQL_STYLE",width:32,alignment:taCenter}).title.caption = "分类";
       DBGrid.items.addEx({fieldName:"SQLATT",width:90,alignment:taLeft,buttonStyle:cbsSelect}).title.caption = "执行类型";   
       DBGrid.columns[3].pickListNo = [4,5];
       DBGrid.columns[3].pickListName = ["存储过程","SQL语句"];
   
       //DBGrid.items.addEx({fieldName:"PROCNAME",width:200}).title.caption = "存储过程名称";      
