          ...
          <td valign="top" style="border:#990000 solid 1px"><table width="100%" border="0" cellpadding="2" cellspacing="0" bordercolor="#dddddd">
            <tr>
              ...
              <table border="0" height="100%" width="100%">
                <tr><td class="tdtitle" align="center">专柜营业统计表</td>
...
<td valign="top">
  ...
  QrGrid.addEx({Caption:"专柜代码",FieldName:"counterid",AlignMent:"center",Width:128});
  QrGrid.addEx({Caption:"专柜名称",FieldName:"counter",AlignMent:"center",Width:0});
  QrGrid.addEx({Caption:"订单数",FieldName:"billcount",AlignMent:"center",Width:88});
  QrGrid.addEx({Caption:"其中现金支付",FieldName:"pbillcount",AlignMent:"center",Width:88});
  QrGrid.addEx({Caption:"合计金额",FieldName:"totalamount",AlignMent:"right",Width:120,DataFormat:"0.00"});
  QrGrid.addEx({Caption:"折扣金额",FieldName:"discount",AlignMent:"right",Width:120,DataFormat:"0.00"});
