...
<script>
 ...
 function doLoad(){
  ...
  function doQuery(att){
    __$Query.getPageCountEx([SDATE.value,EDATE.value,zgInp.value,syyInp.value,dhInp.value],
...
<center>
<table width="1240" border="0" cellpadding="1" cellspacing="1">
  <tr>
          ...
          <td valign="top" style="border:#990000 solid 1px"><table width="100%" border="0" cellpadding="2" cellspacing="0" bordercolor="#dddddd">
            <tr>
              ...
              <table border="0" height="100%" width="100%">
                <tr><td class="tdtitle" align="center">订单查询</td>
            ...
            <tr>
              <td height="40" align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="56" align="center">单号</td>
                  <td width="112" align="center"><input name="dhInp" type="text" class="queryinput" id="dhInp" value="" style="width:112px"></td>
...
<script>
  ...
  QrGrid.addEx({Caption:"订单号",FieldName:"billid",AlignMent:"center",Width:0});
  QrGrid.addEx({Caption:"订单时间",FieldName:"lastuptime",AlignMent:"center",Width:150});
  QrGrid.addEx({Caption:"商品数",FieldName:"count",AlignMent:"center",Width:56});
  QrGrid.addEx({Caption:"金额",FieldName:"totalamount",AlignMent:"right",Width:90,DataFormat:"0.00"});
  QrGrid.addEx({Caption:"折扣",FieldName:"discountsummary",AlignMent:"right",Width:90,DataFormat:"0.00"});
  QrGrid.addEx({Caption:"应收",FieldName:"amount",AlignMent:"right",Width:90,DataFormat:"0.00"});
  QrGrid.addEx({Caption:"收银员",FieldName:"cashier",AlignMent:"center",Width:80});
  QrGrid.addEx({Caption:"营业员",FieldName:"sales",AlignMent:"center",Width:80});
  QrGrid.addEx({Caption:"终端号",FieldName:"counterid",AlignMent:"center",Width:64});
  QrGrid.addEx({Caption:"专柜号",FieldName:"gwbh",AlignMent:"center",Width:64});
  QrGrid.addEx({Caption:"专柜名",FieldName:"counter",AlignMent:"center",Width:120});
  QrGrid.addEx({Caption:"方式",FieldName:"paidbycash",AlignMent:"center",Width:56});
  QrGrid.addEx({Caption:"状态",FieldName:"statename",AlignMent:"center",Width:72});
  ...
  <tr align="center">
   <td width="40">
      <select id="pageSelect" style="width:48px; height:22px" onChange="doSelectChange(this);">
